...
describe("Wholesale Pricing Engine (B2B Volume Breaks & Margin)", () => {
  ...
  it("should calculate Starter Wholesale tier for 24 pairs (MOQ)", async () => {
    ...
    vi.spyOn(prisma.product, "findFirst").mockResolvedValueOnce({
      ...
      cartonQty: 24,
      bulkPriceTiers: [
        { id: "t1", productId: "prod-001", minQty: 24, maxQty: 49, unitPrice: 1850.0, tierLabel: "Starter Wholesale" },
        { id: "t2", productId: "prod-001", minQty: 50, maxQty: 199, unitPrice: 1650.0, tierLabel: "Dealer Batch" },
        { id: "t3", productId: "prod-001", minQty: 200, maxQty: 499, unitPrice: 1450.0, tierLabel: "Wholesale Master" },
        { id: "t4", productId: "prod-001", minQty: 500, maxQty: null, unitPrice: 1299.0, tierLabel: "Container Bulk" },
      ],
    } as any);
