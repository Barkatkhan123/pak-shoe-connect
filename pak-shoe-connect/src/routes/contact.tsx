...
function Contact() {
  ...
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Contact"
        title="Talk to our wholesale sales team."
        description="We respond within 1 working hour, 7 days a week."
      />
              ...
              {ok ? (
                ...
                <>
                  ...
                  <Field label="Message" required>
                    <textarea required rows={5} className={inp} />
                  </Field>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="mt-2 text-xs space-y-1.5 text-muted-foreground">
                    <p>
                      <strong className="text-foreground">Lahore Facility:</strong> Main Market,
                      Gulberg III / Industrial Area, Lahore, Pakistan
                    </p>
                    <p>
                      <strong className="text-foreground">Rawalpindi Facility:</strong> Industrial
                      Estate, Rawalpindi, Pakistan
                    </p>
                  </div>
                </div>
              </div>
...
function ContactCard({
  ...
  return (
    <a
      href={href}
      className={`flex items-center gap-4 rounded-xl border p-5 transition hover:shadow-md ${accent ? "border-whatsapp/30 bg-whatsapp/5" : "border-border bg-card"}`}
    >
      <div
        className={`grid h-11 w-11 shrink-0 place-items-center rounded-lg ${accent ? "bg-whatsapp text-white" : "bg-primary text-primary-foreground"}`}
      >
