        ...
        {ok ? (
          <div className="rounded-2xl border border-emerald/30 bg-cream p-8 text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Our business development team reviews distributor applications within 3–5 working
              days.
            </p>
          </div>
        ) : (
          ...
          >
            ...
            <Field label="Warehouse details" required>
              <textarea
                required
                rows={3}
                placeholder="Location, size (sq ft), storage capacity…"
                className={inp}
              />
            </Field>
            <Row>
            ...
            <Field label="Existing brands handled">
              <textarea
                rows={2}
                placeholder="Other footwear or apparel brands you currently distribute"
                className={inp}
              />
            </Field>
