      ...
      <section className="relative w-full h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-slide-up">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed text-balance">
            Dual manufacturing facilities in Rawalpindi & Lahore — engineered for nationwide B2B
            scale, custom OEM production, and direct factory pricing.
          </p>
        </div>
      </section>
      ...
      <section className="relative z-20 max-w-[1440px] mx-auto px-4 sm:px-6 -mt-16 mb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {[
            ...
            <div
              key={stat.label}
              className="glass rounded-2xl p-6 md:p-8 text-center premium-shadow border border-white/40"
            >
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Strategically located manufacturing hubs in Rawalpindi and Lahore to serve retailers
              and wholesale buyers across Pakistan.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-border bg-card p-8 premium-shadow transition-all duration-300 hover:border-primary/30">
              ...
              <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                Specialized in traditional craftsmanship, handcrafted Peshawari chappals, full-grain
                leather Oxfords, precision laser cutting, and master artisan upper stitching lines.
              </p>
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 rounded-lg bg-muted/40 border border-border/50">
                  <span className="text-muted-foreground block">Key Focus</span>
                  <strong className="text-foreground font-semibold">
                    Leather & Peshawari Craft
                  </strong>
                </div>
                <div className="p-3 rounded-lg bg-muted/40 border border-border/50">
            ...
            <div className="rounded-2xl border border-border bg-card p-8 premium-shadow transition-all duration-300 hover:border-primary/30">
              ...
              <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
                High-capacity industrial sole moulding (PU, TPR, and vulcanized rubber), automated
                sneaker assembly lines, 3-stage QC testing labs, and central warehouse logistics.
              </p>
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 rounded-lg bg-muted/40 border border-border/50">
                  <span className="text-muted-foreground block">Key Focus</span>
                  <strong className="text-foreground font-semibold">
                    Sole Moulding & Assembly
                  </strong>
                </div>
                <div className="p-3 rounded-lg bg-muted/40 border border-border/50">
                  <span className="text-muted-foreground block">Daily Output</span>
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg">
              We control every step of the supply chain in-house, ensuring zero delays and
              uncompromising quality for your bulk orders.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Automated cutters and skilled leather masters. Zero-waste patterning for consistent grading.",
              },
              {
                icon: Factory,
                title: "Stitching Lines",
                body: "Dedicated men's, women's and kids' stitching floors. Quality-tuned machines per shoe type.",
              },
              {
                icon: Boxes,
                title: "Sole Moulding",
                body: "In-house PU, TPR and rubber sole plants. No outsourcing means faster lead times.",
              },
              {
                icon: BadgeCheck,
                title: "3-Stage QC",
                body: "Material check, in-line audit, and pre-pack inspection. Every carton signed off by masters.",
              },
              {
                icon: PackageCheck,
                title: "OEM Packing",
                body: "Branded boxes, insoles, hangtags for private-label orders. Master cartons ready for freight.",
              },
              {
                icon: Warehouse,
                title: "Warehousing",
                body: "Buffer stock on best-sellers for 48-hour dispatch. Nationwide freight partners for fast delivery.",
              },
            ].map((s) => (
              <div
                key={s.title}
      ...
      <section className="py-20 bg-muted/30 border-t border-border">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-10">
            Our facilities meet the highest international compliance and quality standards, making
            us a trusted partner for global exports.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <div
                key={cert}
                className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-emerald/10 border border-emerald/20 text-emerald font-medium text-sm animate-badge-pop"
              >
