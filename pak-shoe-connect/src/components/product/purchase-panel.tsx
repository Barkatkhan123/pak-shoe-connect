    ...
    <div className="sticky top-24 rounded-2xl border border-border premium-shadow glass bg-background/80 p-6 flex flex-col gap-6">
      ...
      <div className="rounded-xl border border-primary/20 bg-primary/5 p-3.5 space-y-2 text-xs">
        ...
        <div className="space-y-1 text-muted-foreground">
          ...
          <div>
            <strong className="text-foreground">Sample Order:</strong> 1 sample pair can also be
            ordered
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex justify-between items-end">
          <span className="text-lg font-medium text-foreground">
            {totalPairs} Pairs{" "}
            {totalPairs > 0 &&
              `(${Math.floor(totalPairs / 12)} Ctn${Math.floor(totalPairs / 12) === 1 ? "" : "s"})`}
          </span>
          <span className="font-display text-3xl gradient-text font-semibold">
