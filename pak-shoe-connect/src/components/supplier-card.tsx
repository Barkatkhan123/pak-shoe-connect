  ...
  return (
    <div className="bg-white border border-border rounded-lg p-5 shadow-sm space-y-5">
      ...
      <div className="grid grid-cols-2 gap-y-3 text-sm border-t border-b border-border py-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="font-semibold text-gray-900 flex items-center gap-1">
            <Star className="w-3 h-3 fill-gold text-gold" /> {rating}/5
          </span>
        </div>
        <div className="flex flex-col gap-1">
      ...
      <div className="flex flex-col gap-2">
        <Link
          to="/contact"
          className="w-full text-center py-2 text-sm font-semibold text-white bg-primary rounded-md hover:bg-orange-600 transition"
        >
          Contact Supplier
        </Link>
        <Link
          ...
          className="w-full text-center py-2 text-sm font-semibold text-gray-700 border border-border rounded-md hover:bg-gray-50 transition flex items-center justify-center"
        >
          Visit Store
        </Link>
      </div>
