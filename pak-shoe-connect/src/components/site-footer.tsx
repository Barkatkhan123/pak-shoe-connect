    ...
    <footer className="border-t border-[#E0D9CE] bg-[#0F1A13] text-[#FAF7F2]">
      ...
      <div className="border-t border-white/10 bg-black/40">
        <style dangerouslySetInnerHTML={{ __html: `
          @keyframes heartPulseBlink {
            0%, 100% { opacity: 1; transform: scale(1); }
            50% { opacity: 0.25; transform: scale(1.2); }
          }
          .blinking-white-heart {
            animation: heartPulseBlink 1.4s infinite ease-in-out;
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 pt-6 pb-[150px] sm:pb-8 text-xs text-[#FAF7F2]/70 sm:flex-row">
          <div className="flex flex-col sm:flex-row items-center gap-3 text-center sm:text-left">
            ...
            {/* Dedicated 50px Height Badge for Made with White Heart by Barkat with inline bottom margin on mobile */}
            <div 
              style={{ 
                minHeight: "50px", 
                height: "50px", 
              ...
              className="px-4 py-2 rounded-xl bg-white/10 border border-white/15 inline-flex items-center justify-center gap-1.5 shadow-sm"
            >
              <span className="text-xs font-semibold text-[#FAF7F2]">Made with</span>
              <span className="text-base leading-none text-white blinking-white-heart">🤍</span>
