...
export function MOQInfoCard({ variant = "short", className = "" }: MOQInfoCardProps) {
  ...
  if (variant === "compact") {
    return (
      <div className={`rounded-xl border border-amber-500/20 bg-amber-500/5 p-3 text-xs text-amber-900 dark:text-amber-200 ${className}`}>
  ...
  if (variant === "full") {
    return (
      <div className={`rounded-2xl border border-border bg-card p-5 shadow-xs space-y-4 ${className}`}>
        <div className="flex items-center justify-between border-b border-border/60 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h4 className="font-bold text-sm text-foreground">Wholesale Order & Packing Policy</h4>
              <p className="text-xs text-muted-foreground">Standardized factory packaging & order rules</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
          <div className="flex items-start gap-2.5 rounded-xl bg-muted/40 p-3 border border-border/50">
            ...
            <div>
              <span className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground block">Minimum Order</span>
          ...
          <div className="flex items-start gap-2.5 rounded-xl bg-muted/40 p-3 border border-border/50">
            ...
            <div>
              <span className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground block">Packing Specification</span>
          ...
          <div className="flex items-start gap-2.5 rounded-xl bg-muted/40 p-3 border border-border/50">
            ...
            <div>
              <span className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground block">Order Quantity Multiples</span>
              <span className="text-xs font-semibold text-foreground">Multiples of 12 pairs only</span>
            </div>
          </div>
